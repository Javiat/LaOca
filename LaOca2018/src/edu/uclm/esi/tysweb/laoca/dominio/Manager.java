...
public class Manager {
	...
	public boolean cambiarContrasena(String email,String pwdvieja, String pwdnueva) throws Exception {
		return UsuarioRegistrado.cambiarContrasena(email,pwdvieja, pwdnueva);
	}
